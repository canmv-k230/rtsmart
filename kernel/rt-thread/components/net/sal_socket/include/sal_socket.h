...
#define MSG_NOSIGNAL    0x20    /* SIGPIPE is not generated by SAL */

/* Output flags returned in struct sal_msghdr::msg_flags. */
#define SAL_MSG_TRUNC   0x04
#define SAL_MSG_CTRUNC  0x08
