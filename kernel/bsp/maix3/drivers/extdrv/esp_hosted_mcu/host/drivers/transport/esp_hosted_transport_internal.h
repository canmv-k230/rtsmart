...
struct eh_transport_ops
{
    ...
    void (*deinit)(struct eh_transport *transport);
...
struct eh_transport
{
    ...
    rt_bool_t tx_event_initialized;
    rt_bool_t ctrl_queue_initialized;
    rt_bool_t data_queue_initialized;
    rt_bool_t backend_initialized;
    rt_bool_t thread_started;
#ifdef ESP_HOSTED_BLE
    rt_bool_t hci_queue_initialized;
#endif
