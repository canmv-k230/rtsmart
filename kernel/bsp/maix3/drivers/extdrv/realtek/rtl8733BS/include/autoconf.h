...
#ifndef CONFIG_TX_SKB_SEMA
#define CONFIG_TX_SKB_SEMA                   0
#endif
...
//only support sdio now
#ifndef CONFIG_TX_AMPDU_CONSIDER_TRAFFIC
#define CONFIG_TX_AMPDU_CONSIDER_TRAFFIC 1
#endif

#ifndef CONFIG_VCS_TYPE
#define CONFIG_VCS_TYPE 0 //0: not specified  1: RTS_CTS  2: CTS_TO_SELF
#endif

extern unsigned int g_user_busy_traffic_thres;
#ifndef CONFIG_BUSY_TRAFFIC_THRESHOLD
	#define CONFIG_BUSY_TRAFFIC_THRESHOLD g_user_busy_traffic_thres
#endif
...
#ifndef NOT_SUPPORT_NEW_SRRC
	#define NOT_SUPPORT_NEW_SRRC            0
#endif
...
/* For DM support */
	...
	*/
    ...
    #ifndef CONFIG_ONLY_SUPPORT_D_CUT_8733
		#define CONFIG_ONLY_SUPPORT_D_CUT_8733	0
	#endif
#endif
...
#endif
#if CONFIG_AP_MODE
#ifndef CONFIG_SAE_AP_MODE_SUPPORT
	#define CONFIG_SAE_AP_MODE_SUPPORT				0
#endif
#endif
...
/* For WPA2 */
	...
	#define CONFIG_INCLUDE_WPA_PSK				1
		...
		#else
			#define CONFIG_MULTIPLE_WPA_STA			0
		#endif
	#endif
	...
	#endif
	//for ap support TKIP sec algorithm
	#ifndef AP_PSK_SUPPORT_TKIP
		#define AP_PSK_SUPPORT_TKIP             0
	#endif
#else
...
//For ap mode，can set to wep or tkip sec
#ifndef CONFIG_FPGA_AP_WEP_TKIP
	#define CONFIG_FPGA_AP_WEP_TKIP				0
#endif

#if CONFIG_FPGA_AP_WEP_TKIP
	#define AP_PSK_SUPPORT_TKIP             1
#endif
...
/* For WPS and P2P */
	...
	#define CONFIG_SUPPORT_AUTO_GO_PRESISTENT_GROUP     0
#endif
#endif
...
#ifndef CONFIG_RW_PHYSICAL_EFUSE
	#define CONFIG_RW_PHYSICAL_EFUSE			0
#endif
#ifndef CONFIG_HIDE_PROTECT_EFUSE
...
//for wifi logo certification config
#ifndef WIFI_LOGO_CERTIFICATION_CONFIG
...
//for KRM-8821CS
#ifndef CONFIG_USE_LITTLE_ENDIAN
	#define CONFIG_USE_LITTLE_ENDIAN			1// = 1 for little endian(default), = 0 for big endian
#endif
#if CONFIG_USE_LITTLE_ENDIAN
